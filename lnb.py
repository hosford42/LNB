...
# module, which extends the standard Naive Bayes classification algorithm
# to improve classification accuracy. This module implements both Naive
# Bayes (NB) and Less Naive Bayes (LNB) classifiers. It also implements
...
#       - Created this module.
#   11/07/2014:
#       - Modified NonNaiveBayesEstimator to accept a layer factory
#         function which defaults to the InertialNaiveBayesEstimator class
#         constructor. Added weight & bias parameters to
#         InertialNaiveBayesEstimator's and NonNaiveBayesEstimator's
#         observe() methods.
#   07/03/2015:
#       - Renamed module from bayes_estimation.py to lnb.py
#       - Revamped module header
#       - Renamed NaiveBayesEstimator to NBClassifier
#       - Renamed InertialNaiveBayesEstimator to INBClassifier
#       - Renamed NonNaiveBayesEstimator to LNBClassifier
#       - Adjusted classes to apply Laplacian smoothing at the end, rather
#         than in the table counts, since this makes it easier to determine
#         appropriate smoothing values and also reduces memory usage.
#       - Renamed cautious_accuracy to conservative_accuracy
#   07/04/2015:
#       - Removed min_depth and initial_depth; use 1 in place of each.
#       - Removed layer factory function; always use INBClassifier.
#
# =============================================================================
...
# - Modify NB and INB implementations to work with logarithms instead of '
#   raw counts.
